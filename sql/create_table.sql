...
CREATE TABLE data_user (
    user_id_user    CHAR(15) NOT NULL UNIQUE,
    nilai_rapot     BLOB,
    akta_kelahiran  BLOB,
    ijazah          BLOB,
...
CREATE TABLE registration (
    ...
    FOREIGN KEY (school_registration_path_school_id_school, 
        ...
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    UNIQUE (user_id_user, school_registration_path_school_id_school, school_registration_path_registration_path_id_registration_path)
) ENGINE=InnoDB;
